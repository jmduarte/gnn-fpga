...
class Estimator():
    ...
    def load_weights(self, filename='checkpoint.pt'):
        ...
        if self.model.edge_network.network[0].mask_flag:
            self.model.edge_network.network[0].weight.data = old_model.edge_network.network[0].weight.data*self.model.edge_network.network[0].mask.data
        else:
            print('mask_flag=FALSE')
            self.model.edge_network.network[0].weight.data = old_model.edge_network.network[0].weight.data
        if self.model.edge_network.network[2].mask_flag:
            self.model.edge_network.network[2].weight.data = old_model.edge_network.network[2].weight.data*old_model.edge_network.network[2].mask.data
        else:
            self.model.edge_network.network[2].weight.data = old_model.edge_network.network[2].weight.data
        if self.model.node_network.network[0].mask_flag:
            self.model.node_network.network[0].weight.data = old_model.node_network.network[0].weight.data*old_model.node_network.network[0].mask.data
        else: 
            self.model.node_network.network[0].weight.data = old_model.node_network.network[0].weight.data
        if self.model.node_network.network[0].mask_flag:
            self.model.node_network.network[2].weight.data = old_model.node_network.network[2].weight.data*old_model.node_network.network[2].mask.data
        else: 
            self.model.node_network.network[2].weight.data = old_model.node_network.network[2].weight.data
